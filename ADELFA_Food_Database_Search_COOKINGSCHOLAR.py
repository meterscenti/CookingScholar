...
def Search(allergen, UserIngredients):
    ...
    recipes = {"Fish Fillet" : [["fish", "egg", "flour"],0, False, 1],
               ...
               "Tinola" : [["chicken","malunggay","labuyo leaf","pepper","papaya","chicken cube","onion","garlic","ginger","fish sauce","oil"],0,False,4],
               "Adobo" : [["chicken","chicken cube","garlic","vinegar","soy sauce","pepper","bay leaf","sugar","oil"],0,False,5],
               "Sinigang" : [["pork","tomato","onion","fish sauce","taro","radish","chili","bean","eggplant","sinigang mix","pechay"],0,False,6]
               }
